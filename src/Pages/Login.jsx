            ...
            <div className="flex h-full w-full overflow-hidden rounded-xl shadow-md">
                ...
                <div className="relative hidden items-center justify-center bg-[#18181B] md:flex md:w-[50%]">
                    ...
                    <div className="z-10 space-y-2 text-center">
                        <h2 className="animate-pulse text-3xl font-medium text-white/80">Welcome Back</h2>
                        <p className="animate-pulse text-white/60">Please Enter You Information</p>
                    </div>
                </div>
                {/* form side  */}
                <div className="flex w-full flex-col justify-center bg-white py-10 lg:w-[60%] dark:bg-zinc-900">
                    <h2 className="pb-8 text-center text-3xl font-semibold tracking-tight text-white">Please Login</h2>
                    <form onSubmit={handleLogin} className="flex w-full flex-col items-center justify-center gap-4">
                        ...
                        <p className="text-[14px] text-gray-400">
                            Do not have an account ? <a href='/register' className="text-white">Create one</a>
                        </p>
                        <button className="uppercase w-[80%] rounded-lg bg-white px-6 py-2 font-medium text-black outline-none hover:bg-zinc-200 md:w-[60%]" type="submit">
                            Submit
                        </button>
                    </form>
                    {/* divider  */}
                    ...
                    {/* sign with google */}
                    <button onClick={handleGoogleSign} className="group mx-auto flex h-[50px] w-fit items-center overflow-hidden rounded-full shadow-md outline-none ring-1 ring-white">
