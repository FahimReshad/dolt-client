...
const Register = () => {
    ...
    return (
        <div className="flex h-full items-center justify-center md:p-0 lg:w-1/2 container mx-auto mt-20">
            <div className="flex h-full w-full overflow-hidden rounded-xl shadow-md">
                ...
                <div className="flex w-full flex-col justify-center bg-white py-10 lg:w-[60%] dark:bg-zinc-900">
                    <h2 className="pb-8 text-center text-3xl font-semibold tracking-tight text-white">Please Registration</h2>
                    <form onSubmit={handleRegister} className="flex w-full flex-col items-center justify-center gap-4">
                        ...
                        <p className="text-[14px] text-gray-400">
                            Do you have an account ? <a href='/login' className="text-white">please login</a>
                        </p>
                    ...
                    {/* sign with google */}
                    <button className="group mx-auto flex h-[50px] w-fit items-center overflow-hidden rounded-full shadow-md outline-none ring-1 ring-white">
